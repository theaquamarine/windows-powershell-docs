...
online version: 
schema: 2.0.0
title: Remove-NetworkControllerAccessControlListRule
ms.assetid: D78BA4E5-6DEE-4040-8738-E8AFBD4EC5E5
---
...
```
Remove-NetworkControllerAccessControlListRule -AccessControlListId <string> -ConnectionUri <Uri>
...
### -AccessControlListId
Specifies the access control list where the rule belongs
...
### -ResourceId
Specifies the resource ID of the rule to be removed
