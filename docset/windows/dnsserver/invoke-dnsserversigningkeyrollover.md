...
For more information about DNS server signing keys, see the **Key Management** section of [Overview of DNSSEC](http://technet.microsoft.com/en-us/library/jj200221.aspx).

## EXAMPLES

### Example 1: Invoke key rollover
```
