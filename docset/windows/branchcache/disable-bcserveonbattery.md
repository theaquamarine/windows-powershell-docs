...
### Example 1: Configure a computer to ignore content discovery requests
```
PS C:\> Disable-BCServeOnBattery
```

This command configures the computer to ignore content discovery requests from peers.
