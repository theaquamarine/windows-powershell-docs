...
```
Remove-NetworkControllerPublicIpAddress -ConnectionUri <Uri> -ResourceId <string>
...
### Example 1
```
Remove-NetworkControllerPublicIpAddress -ConnectionUri https://networkcontroller -ResourceId publicIP1
```
...
### -ResourceId
Specifies the unique ID of the resource to be removed
