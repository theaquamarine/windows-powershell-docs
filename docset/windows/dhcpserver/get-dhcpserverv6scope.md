...
### Example 1: Get scope information for all scopes
```
...
### Example 2: Get scope information for a specified scope
```
...
### -Prefix
Specifies the IPv6 prefixes for which the cmdlet gets the scope information.
