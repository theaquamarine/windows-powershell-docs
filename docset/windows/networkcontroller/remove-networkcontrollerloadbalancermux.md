...
online version: 
schema: 2.0.0
title: Remove-NetworkControllerLoadBalancerMux
ms.assetid: 9B4D1C49-F618-43A1-ACCF-4A6DF1C20AD9
---
...
```
Remove-NetworkControllerLoadBalancerMux -ConnectionUri <Uri> [-CertificateThumbPrint <string>]
 [-Credential <PSCredential>] [-Etag <string>] [-Force] [-ResourceId <string>]
```
