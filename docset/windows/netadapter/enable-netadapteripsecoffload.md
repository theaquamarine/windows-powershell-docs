...
### ByInstanceID
```
Enable-NetAdapterIPsecOffload -InterfaceDescription <String[]> [-IncludeHidden] [-NoRestart] [-PassThru]
 [-CimSession <CimSession[]>] [-ThrottleLimit <Int32>] [-AsJob] [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
The IPsec encryption algorithm supported by the network adapter must also be configured in the IPsec policy before connections can be offloaded.
