...
## DESCRIPTION
The **Disable-NetAdapterRdma** cmdlet disables remote direct memory access (RDMA) on a network adapter.
RDMA can increase networking throughput, reduce latency, and reduce processor utilization.

## EXAMPLES

### Example 1: Disable RDMA on the specified network adapter
```
PS C:\> Disable-NetAdapterRdma -Name "MyAdapter"
```

This command disables RDMA on the network adapter named MyAdapter and restarts the network adapter.
