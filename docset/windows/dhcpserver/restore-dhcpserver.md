...
```
Restore-DhcpServer [-ComputerName <String>] [-Path] <String> [-Force] [-CimSession <CimSession[]>]
...
### Example 1: Restore a DHCP server service database
```
...
### -Path
Specifies the path of the location where the backup database is stored.
