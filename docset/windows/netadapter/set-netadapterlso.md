...
### Example 1: Enable LSO for IPv4 and disable LSO for IPv6 on the specified network adapter
```
PS C:\> Set-NetAdapterLso -Name "MyAdapter" -IPv4Enabled $True -IPv6Enabled $False
```

This command enables LSO for IPv4 and disables LSO for IPv6 on the network adapter named MyAdapter.
...
### -IPv4Enabled
Indicates whether LSO for IPv4 traffic is enabled.
...
### -IPv6Enabled
Indicates whether LSO for IPv6 traffic is enabled.
...
### -V1IPv4Enabled
Indicates whether LSO for V1IPv4 on the network adapter is enabled.
