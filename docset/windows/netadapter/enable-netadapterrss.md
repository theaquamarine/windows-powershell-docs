...
### Example 1: Enable RSS on the specified network adapter
```
...
### Example 2: Enable RSS on all RSS capable network adapters
```
PS C:\> Enable-NetAdapterRss -Name "*"
```

This command enables RSS on all RSS capable network adapters.
