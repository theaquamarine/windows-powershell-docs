...
## DESCRIPTION
The **Disable-NetAdapterRss** cmdlet disables receive side scaling (RSS) on a network adapter.
...
### Example 1: Disable RSS on the specified network adapter
```
PS C:\> Disable-NetAdapterRss -Name "MyAdapter"
```

This command disables RSS on the network adapter named MyAdapter and restarts the network adapter.
