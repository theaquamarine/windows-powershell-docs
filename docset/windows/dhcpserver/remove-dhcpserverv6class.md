...
### Example 2: Remove a vendor class
```
...
### -Name
Specifies the name of the vendor or user class that is deleted.
...
### -Type
Specifies the type of the class that is deleted.
