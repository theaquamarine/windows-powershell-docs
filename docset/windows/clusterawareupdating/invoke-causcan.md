...
For more information about how plug-ins work with Cluster-Aware Updating (CAU), see [Cluster-Aware Updating plug-ins](http://go.microsoft.com/fwlink/p/?LinkId=235333).
