...
ms.assetid: 9DEDCC90-63ED-4BD3-B33F-2088B1030353
---
...
### Query (cdxml) (Default)
```
Remove-ClusterGroupSet [[-Name] <String[]>] [-CimSession <CimSession[]>] [-ThrottleLimit <Int32>] [-AsJob]
 [-PassThru] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### InputObject (cdxml)
```
Remove-ClusterGroupSet -InputObject <CimInstance[]> [-CimSession <CimSession[]>] [-ThrottleLimit <Int32>]
 [-AsJob] [-PassThru] [-WhatIf] [-Confirm] [<CommonParameters>]
```

## DESCRIPTION
Removes a group set from the cluster.
The group set cannot be a provider for another group set.
...
### -Name
Specifies an array of names of the group set to remove.
