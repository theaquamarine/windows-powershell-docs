...
This allows for rule querying based on the *InterfaceAlias* parameter; this cmdlet returns filter objects that may be further queried with the [Where-Object](http://go.microsoft.com/fwlink/?LinkID=113423) cmdlet.
